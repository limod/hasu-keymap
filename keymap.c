...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_PGUP]  = ACTION_TAP_DANCE_DOUBLE(KC_X,KC_PGUP),
...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] PROGMEM = {
    ...
    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   KC_Y,   KC_U,   LT(MOUSE,KC_I), LT(SYMBS,KC_O),    KC_P,    KC_LBRC, KC_RBRC,          KC_BSLS,     KC_DEL,  KC_END,  KC_PGDN,    KC_P7,   KC_P8,   KC_P9,   KC_PPLS,    KC_MENU, KC_UNDO,
    ...
    TD(TD_SHIFT), KC_NUBS, KC_Z,     TD(TD_PGUP),   TD(TD_PGDN),    KC_V,   TD(TD_POS),    TD(TD_ARROW_LEFT),    TD(TD_ARROW_RIGHT), TD(TD_ARROW_UP), TD(TD_ARROW_DOWN),  TD(TD_END),          KC_RO,   KC_RSFT,              KC_UP,               KC_P1,   KC_P2,   KC_P3,   KC_PEQL,    KC_EXEC, KC_PSTE,
    KC_LALT, KC_LGUI, KC_LCTL, KC_MHEN, KC_HANJ,         KC_SPC,         KC_HAEN, KC_HENK, KC_KANA, KC_RALT, KC_RGUI, KC_APP,  KC_RCTL,     KC_LEFT, KC_DOWN, KC_RGHT,    KC_P0,            KC_PDOT, KC_PENT,    KC_FIND, KC_CUT
    ),
    [MOUSE] = LAYOUT_all(
    ...
    ______,           ______,  ______,  ______, ______, ______,  ______,  ______, ______,  ______, ______, ______, ______,             ______,______,______,    ______,______,______,______,    ______,
    ______,  ______,  ______,  ______,  ______, ______, ______,  ______, ______, ______,  ______, ______, ______, ______, ______,     ______,______,______,    ______,______,______,______,    ______,______,
    ______,  ______,  ______,  ______,  ______, ______, ______,  KC_HOME,  KC_UP, KC_END,  ______, ______, ______,         ______,     ______,______,______,    ______,______,______,______,    ______,______,
    ______,  ______,  ______,  ______,  ______, ______, ______,  KC_LEFT,  KC_DOWN, KC_RIGHT,  ______, ______,         ______, ______,                              ______,______,______,______,    ______,______,
    ______,  ______,  ______,  ______,  ______, ______, TD(TD_POS),    TD(TD_ARROW_LEFT),    TD(TD_ARROW_RIGHT), TD(TD_ARROW_UP), TD(TD_ARROW_DOWN),  TD(TD_END),         ______, ______,            ______,           ______,______,______,______,    ______,______,
    ______,  ______,  ______,  ______,  ______,         ______,           ______, ______,  ______, ______, ______, ______, ______,     ______,______,______,    ______,       ______,______,    ______,______
    ),
    [SYMBS] = LAYOUT_all(
                      ______,  ______,  ______, ______, ______,  ______,  ______, ______,  ______, ______, ______, ______,
